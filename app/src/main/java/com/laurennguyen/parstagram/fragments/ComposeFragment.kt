...
import com.laurennguyen.parstagram.MainActivity
import com.laurennguyen.parstagram.Post
import com.laurennguyen.parstagram.R
import com.parse.ParseFile
import com.parse.ParseUser
import java.io.File

/**
 * Let users create a post by taking a photo with their camera
 */
    ...
    fun submitPost(description: String, user: ParseUser, file: File) {
        ...
        post.saveInBackground{ exception ->
            if (exception != null) {
                ...
                Toast.makeText(requireContext(),"Something went wrong while saving post", Toast.LENGTH_SHORT).show()
            } else {
